package com.example.exercismjava.exercise;
...
replace <file> with the relative location of your hello-world.java file. so if you are working in "C:\exercism\java\hello-world" then the command would be</file>
